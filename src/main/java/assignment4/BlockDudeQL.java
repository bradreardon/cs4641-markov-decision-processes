...
//        final int numIter = reader.nextInt();
		final int numIter = 25;

        QLearning ql = new QLearning(domain, 0.95, new SimpleHashableStateFactory(), 100, 0.1);
        ql.setLearningRateFunction(new SoftTimeInverseDecayLR(.1, 100000));
        ql.setLearningPolicy(new EpsilonGreedy(ql, .1));
